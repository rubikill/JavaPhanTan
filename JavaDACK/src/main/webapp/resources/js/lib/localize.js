...
//                alert("success");
            ...
            initLocalizedResources:function () {
                ...
                return $q.all([$http({ method:"GET", url:url, cache:false }).success(localize.successCallback).error(function () {
            ...
            getLocalizedStringWithParams: function(value, params) {
                
                // default the result to an empty string
                var result = localize.getLocalizedString(value);
                if(params.length >= 1){
