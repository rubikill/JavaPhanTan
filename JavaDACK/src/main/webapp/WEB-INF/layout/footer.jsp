		...
		<div class="row">
			...
			<div id="socialMedia" class="span3 pull-right">
				...
				<a href="#"><img width="60" height="60"
					src='<c:url value="/resources/themes/images/facebook.png"/>'
					title="facebook" alt="facebook" /></a> <a href="#"><img width="60"
					height="60"
					src='<c:url value="/resources/themes/images/twitter.png"/>'
					title="twitter" alt="twitter" /></a> <a href="#"><img width="60"
					height="60"
					src='<c:url value="/resources/themes/images/youtube.png"/>'
